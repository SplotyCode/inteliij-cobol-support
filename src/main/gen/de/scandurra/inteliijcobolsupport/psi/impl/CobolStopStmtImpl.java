...
public class CobolStopStmtImpl extends ASTWrapperPsiElement implements CobolStopStmt {

  public CobolStopStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitStopStmt(this);
  }
