...
public class CobolDataDescriptionImpl extends ASTWrapperPsiElement implements CobolDataDescription {

  public CobolDataDescriptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitDataDescription(this);
  }
