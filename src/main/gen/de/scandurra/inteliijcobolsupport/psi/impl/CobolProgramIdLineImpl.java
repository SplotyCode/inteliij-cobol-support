...
public class CobolProgramIdLineImpl extends ASTWrapperPsiElement implements CobolProgramIdLine {

  public CobolProgramIdLineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitProgramIdLine(this);
  }
